...
#PATH_TO_PELE_IMG="/work/singularity/pele_platform/singularity/pele.img"

########################################

######NOT TO CHANGE#################

singularity exec -B "$PELE_LICENSES:/PELE-repo/licenses,$SCHRODINGER:/schrod/,$SCHR_LIC:/schr_lic/" $PATH_TO_PELE_IMG  bash -c "source /etc/profile.d/01-locale-fix.sh; python -m pele_platform.main $INPUT_NAME"
