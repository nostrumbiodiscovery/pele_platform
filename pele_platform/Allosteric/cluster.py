...
def cluster_best_structures(be_column: int, residue, resnum, chain, topology=None, cpus=20, n_components=10, n_structs=1000, directory=".", logger=None):
    ...
    snapshot = 0
    pool = Pool(cpus)
    input_pool = [[f, snapshot, residue, resnum, chain, topology] for f in files_out]  
