...
from pele_platform.WaterMap.main import run_watermap
...
class Launcher:
    ...
    def launch_package(self, package: str, no_check=False) -> pv.ParametersBuilder:
        ...
        elif package == self.watermap:
            job_variables = run_watermap(self._args)
        return job_variables
    ...
    def _define_package_to_run(self) -> None:
        ...
        elif self._args.watermap:
            self._args.package = self.watermap
        else: 
