...
class SimulationParams(msm_params.MSMParams, glide_params.GlideParams, bias_params.BiasParams, 
    ...
    def __init__(self, args):
        ...
        ppi.PPIParams.__init__(self, args, self.water_arg)
    ...
    def water_params(self, args):
        ...
        self.water_arg = None
        if args.waters:
           self.water_arg = hp.retrieve_all_waters(self.system) if args.waters == "all_waters" else args.waters #IDS of watersi
           ...
           self.water = cs.WATER.format(self.water_radius, self.water_center, self.waters, self.water_temp, self.water_trials, self.water_overlap, self.water_constr)
