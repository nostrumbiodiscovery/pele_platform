...
class SimulationParams(
    ...
    def analysis_params(self, args):
        ...
        self.top_clusters_criterion = args.top_clusters_criterion if args.cluster_conditions is not None else "25_percentile"
        self.cluster_representatives_criterion = args.cluster_representatives_criterion if args.cluster_representatives_criterion is not None else "5_percentile"
