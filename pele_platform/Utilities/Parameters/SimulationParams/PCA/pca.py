...
class PCAParams(object):
    ...
    def __init__(self, args):
        ...
        if self.pca or self.pca_traj:
            ...
            self.anm_displacement = args.anm_displacement if args.anm_displacement else self.simulation_params.get("anm_displacement", 1.75)
            self.anm_modes_change = args.anm_modes_change if args.anm_modes_change else self.simulation_params.get("anm_modes_change", 8)
